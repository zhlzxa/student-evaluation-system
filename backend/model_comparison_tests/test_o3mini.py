#!/usr/bin/env python3
"""
Test script for URLRulesExtractor using o3-mini model with Azure AI Projects SDK.
This script tests the URL rules extraction agent with o3-mini model.
"""
...
class TokenCounter:
    ...
    def calculate_cost(input_tokens: int, output_tokens: int, model: str) -> float:
        ...
        # o3-mini pricing: $1.10 input, $4.40 output per 1M tokens
...
async def test_single_url_azure_sdk(url: str, run_number: int = 1) -> Dict[str, Any]:
    """Test URL extraction with o3-mini using Azure SDK."""
    ...
    try:
        ...
        # Step 3: Create or get o3-mini agent
        try:
            # Try to create a new agent with o3-mini
            agent = project.agents.create_agent(
                model="o3-mini",
                name="URL-Rules-Extractor-O3Mini-Test",
            ...
            logger.info(f"Created new o3-mini agent: {agent.id}")
        except Exception as e:
            logger.error(f"Failed to create o3-mini agent: {e}")
            raise
        ...
        estimated_cost = TokenCounter.calculate_cost(input_tokens, output_tokens, "o3-mini")
...
async def run_all_tests() -> List[Dict[str, Any]]:
    ...
    logger.info(f"Starting o3-mini SDK tests on {len(TEST_URLS)} URLs")
...
def save_results(results: List[Dict[str, Any]]) -> None:
    ...
    output_file = "o3mini_url_extractor_results.json"
    ...
    # Print summary
    print("\n" + "="*60)
    print("O3-MINI URL EXTRACTOR TEST SUMMARY")
    print("="*60)
